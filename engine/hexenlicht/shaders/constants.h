...
// Hexenlicht: one model instance per brush or alias entity (vk_instance.c);
// the TLAS has the world's and each brush instance's ranges (opaque,
// transparent, sky) and the dynamic model BLASes (vk_accel.c)
